...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    const selectQuery = 'SELECT id, cliente_id, establecimiento_id, terminal_id, puntos_canjeados, created_at  FROM canjeados WHERE terminal_id = $1 and estado = true; and  created_at = CURRENT_DATE;';
